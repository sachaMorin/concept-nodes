from concept_graphs.perception.segmentation.utils import (
    bbox_overlap,
    mask_subtract_contained_torch,
)
import torch
...
expected_overlap = torch.tensor(
    [[16.0, 4.0, 9.0], [4.0, 4.0, 1.0], [9.0, 1.0, 9.0]]
).long()
